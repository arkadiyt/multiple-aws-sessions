...
describe('cookiejar', () => {
  ...
  it('inserts valid cookies from javascript', () => {
    expect.hasAssertions();

    [
      [cs('a', 'b', {}), 'http://example.com', '/'],
      [cs('a', 'b', { httponly: false }), 'http://example.com', '/'],
      [cs('a', 'b', {}), 'http://example.com/item', '/'],
  ...
  it("doesn't insert invalid cookies from javascript", () => {
    expect.hasAssertions();

    [
      [cs('a', 'b', { httponly: true }), 'http://example.com'],
      [cs('a', 'b', { path: '/item/' }), 'http://example.com/item'],
